...
dnswalk to narzędzie do diagnostyki DNS-ów. Wykonuje transfery stref
dla podanych domen i sprawdza bazę danych w różny sposób pod kątem
wewnętrznej spójności oraz dokładności.
